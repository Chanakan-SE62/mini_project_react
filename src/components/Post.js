    ...
    <div>
      {id.map((datail) => (
        ...
        <Card className="mx-auto" style={{ margin: '20px 0px 20px 0px' }}>
            ...
            <Row>
              ...
              <Col>
                <Label 
                  ...
                  tag="h6"
                >
                  <a href={"/profile/" + datail.user.username} className="text-black text-decoration-none">
          ...
          <CardBody>
            <VscHeart />
            <BiMessageRounded style={{ margin: '0px 0px 0px 4px' }} />
            <CardSubtitle
              className="mb-2"
              tag="h6"
            ...
            <CardText>
              <span><a href={"/profile/" + datail.user.username} 
              class="important">{datail.user.first_name}</a>
